...
class MyTestCase(unittest.TestCase):
    ...
    #     self.driver.get_screenshot_as_file("C:/Users/jhunter/PycharmProjects/FrameWorkDemo2/screenshots/LoginSuccess.png")


if __name__ == '__main__':
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output='C:/Users/jhunter/PycharmProjects/FrameWorkDemo2/reports'),verbosity=2)
